...
% used by Makefile to find this in a heap of html files
\begin{rawhtml}
<a name="changelog-top"></a>
\end{rawhtml}

\textbf{To all supporters: thank you so much for your donations.  See also: \url{http://aquamacs.org/donations.shtml}. To all users and hackers: Thank You for your contributions!  We appreciate your bug reports, success stories, ideas and code.  }
\vskip2em
...
\item Prolog-mode upgraded to 1.23. (Previous version was 1.19.)  (Added support for XSB.)
\end{itemize}
